    ...
    const fetchData = async () => {
      try {
        const response = await instance.post(
          `api/v1/product/filter?page=${page}&limit=${limit}`
        );
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        const saleResponse = await instance.post(
          `api/v1/product/filter?page=1&limit=3`,
          filter
        );
        ...
        setListCategory([
          {
            name: "All",
            id: "all",
            number: `${categoryResponse.data.data.reduce(
          ...
          <div className="row ">
            <div className="col-3">
              <div className="col cot1">
                ...
                <div>
                  <div className="accordion-item">
                    <h2
                      ...
                      id="panelsStayOpen-headingPrice"
                    >
                      <button
                ...
                <img
                  class="sale-pic"
                  src="https://img.freepik.com/free-vector/flat-design-food-sale-banner_23-2149138014.jpg"
                />
                <div>
                  <b>Sales Products</b>
              ...
              <div className="search-bar d-flex align-items-center justify-content-between">
                <div className="d-flex align-items-center">
                  ...
                  <Dropdown overlay={menu} className="marginL8px">
                    <Button>
                      {sort} <span className="anticon anticon-down" />
                      <DownOutlined />
                    </Button>
                  </Dropdown>
                </div>
