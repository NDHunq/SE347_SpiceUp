    ...
    return (
        ...
        >
            <div className="card-content" onClick={showModal}>
                ...
                {hovered ? <p className="primary-color margin0">{props.name}</p> : <p className="margin0">{props.name}</p>}
                <div>
                    <p>
                    <b>đ {formatNumberWithDots((1 - percentSale).toFixed(2) * props.price)} </b>
                    <span className="strikethrough grey">đ {formatNumberWithDots(props.price)}</span>
                    </p>
                </div>    
                <Rate className="rate" allowHalf disabled defaultValue={props.average_rating} />
                </div>
            </div>
            <Modal title="" 
                        ...
                        <div class="info-1">
                            ...
                            <h2 className="accordion-header" id="panelsStayOpen-headingOne">
                                ...
                                <div className="container-review">
                                    <Rate disabled allowHalf defaultValue={star} className="rv-rate" />
                            ...
                            <div className="price-line">
                                {(percentSale*100)>0?
                                <div><p><span className="strikethrough grey">đ {formatNumberWithDots(props.price)}</span><span class="marginl4px sell-price">đ {formatNumberWithDots((1-percentSale).toFixed(2)*props.price)}</span></p></div>
                                :<span className="sell-price " >đ {formatNumberWithDots(props.price)}</span>}
                                <div className="percentSale marginl4px">{(percentSale*100).toFixed(0)}% Off</div>
                            </div>
